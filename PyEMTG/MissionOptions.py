...
class MissionOptions(object):
    ...
    def __init__(self, optionsFileName = None):
        ...
        """NLP solver type. Choices are 0 - SNOPT, 1 - WORHP,#2: IPOPT-MA27, #3: IPOPT-MUMPS"""
        ...
        self.power_decay_type = 0
        """How to model power decay.\n#0: e^(-t * power_decay_rate) \n#2: decay_coeff[0] + decay_coeff[1] * e^(decay_coeff[2] * t) + decay_coeff[3] * t"""
        self.decay_coefficients = [1,0,0,0]
        """Decay coefficients if power_decay_type = 1"""
    ...
    #************************************************************************************write
    def write_options_file(self, optionsFileName, writeAll = True):
