...
namespace EMTG
{
    namespace Astrodynamics
    {
        ...
        public:
            ...
            inline bool getStorePropagationHistory() { return this->store_propagation_history; };
            inline void clearPropagationHistory() { this->propagation_time_history.clear(); this->propagation_state_history.clear();};
            virtual std::vector<double> getPropagationTimeHistory() const = 0;
            virtual std::vector< std::vector<double> > getPropagationStateHistory() const = 0;
        ...
        protected:
            ...
            std::vector<double> propagation_time_history;
            std::vector< std::vector<double> > propagation_state_history;
