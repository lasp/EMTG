...
namespace EMTG
{
    namespace Phases
    {
            ...
            size_t& eventcount)
        {
            ...
            std::vector<double> forward_propagation_history = this->ForwardHalfPhasePropagator->getPropagationTimeHistory();
            this->ForwardHalfPhasePropagator->setStorePropagationHistory(false);
            ...
            std::vector<double> backward_propagation_history = this->BackwardHalfPhasePropagator->getPropagationTimeHistory();
            this->BackwardHalfPhasePropagator->setStorePropagationHistory(false);
