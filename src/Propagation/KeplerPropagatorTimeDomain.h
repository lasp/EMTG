...
namespace EMTG
{
    namespace Astrodynamics
    {
        ...
        public:
            ...
            //clone
            virtual KeplerPropagatorTimeDomain* clone() const override { return new KeplerPropagatorTimeDomain(*this); }

            // methods
            void propagate(const doubleType& PropagationTime, const bool& needSTM) override;
            ...
            virtual std::vector<double> getPropagationTimeHistory() const override { throw std::runtime_error("KeplerPropagatorTimeDomain::getPropagationHistory not implemented"); };
            virtual std::vector< std::vector<double> > getPropagationStateHistory() const override { throw std::runtime_error("KeplerPropagatorTimeDomain::getPropagationHistory not implemented"); };
